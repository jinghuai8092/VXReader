    ...
    return Column(
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(color: Color(0xffffcf7)),
          child: Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  'Share get free',
                  style: TextStyle(color: Color(0xff4f3b1a), fontSize: 10),
                ),
              ),
            ],
          ),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Reveal the truth of history')
            ],
          ),
        ),
        bottomTitle('Free book to get never done')
      ],
    ));
  }
}
